...
export const WeatherIcons = {
  ...
  "04d": "/react-weather-app/icons/wi-cloudy.svg",
  "04n": "/react-weather-app/icons/wi-snow.svg",
  ...
  "50n": "/react-weather-app/icons/haze.png",
...
function App() {
  ...
  const fetchWeather = async (e) => {
    ...
    const response = await Axios.get(
      `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=6a2fd0534ca9fa2356988eba0d037f23`,
    );
